...
MX_GPIO_Init();
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    ...
    Lcd_cursor(&lcd, 0,1);
    Lcd_string(&lcd, "KANISHKAR M");
    Lcd_cursor(&lcd, 1,1);
    Lcd_string(&lcd, "212222240044");
while (1)
  {
}
}
...
## Output screen shots of proteus  :
 ...
 ![lcd](https://github.com/user-attachments/assets/78878d2b-35d0-4a39-a399-71c582e72cd4)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![image](https://github.com/user-attachments/assets/fffc9537-af81-4c90-a7d0-996f7f17168c)
